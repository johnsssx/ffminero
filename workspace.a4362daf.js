        ...
        var o = function() {
            function n(i) {
                ...
                r.addEventListener("play", function() {
                    o.parentNode.removeChild(o), a.element.classList.add("cue-in"), a.element.style.display = "block", document.title = "MIOP MIOP!"
                });
                var d = document.createElement("button");
                d.textContent = "B O B O", d.addEventListener("click", function(e) {
